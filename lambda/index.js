...
const LaunchRequestHandler = {
  ...
  case 3:
    ...
    "mainTemplate": {
        ...
        "item": {
            ...
            .getResponse();
  case 4:
      escenario = 'Usted se encuentra en una guardería, al caminar por un pasillo se percata de que en el suelo del pasillo se encuentra un lactante aparentemente inconsciente.';
      caso=1;
      paciente=0;
      speakOutput = `Hola, soy tu asistente virtual.  Iniciaremos la práctica de B.L.S. Y el escenario es el siguiente: ${escenario} `;
      speakOutput2 = `Lo lamento, ¿puedes decirlo de nuevo? Prueba a decir: "Es segura" o "No es segura". ¿La escena es segura?`;
                        ...
                        "datasources": {
                            "simpleTextTemplateData": {
                                ...
                                "properties": {
                                    ...
                                    "hintText": "Prueba a decir: \"Es segura\", \"No es segura\", \"¿Que es una escena segura?\"",
                                    "headerAttributionImage": "https://raw.githubusercontent.com/IbaGPE/Asistente-B.L.S/main/Alexa-Logo.png",
                                    "primaryText": "Usted se encuentra en una guardería, al caminar por un pasillo se percata de que en el suelo del pasillo se encuentra un lactante aparentemente inconsciente.",
                                    "textAlignment": "start",
                                    "titleText": "Simulación"
                                }
                            }
  ...
  case 5:
    ...
    "mainTemplate": {
        ...
        "item": {
            ...
            .getResponse();
  case 6:
      escenario = 'Usted se encuentra caminando por la vía pública y encuentra un paciente inconsciente recibiendo maniobras de R.C.P. Por un reanimador.';
      caso=2;
      paciente=1;
      speakOutput = `Hola, soy tu asistente virtual.  Iniciaremos la práctica de B.L.S. Y el escenario es el siguiente: ${escenario} `;
      speakOutput2 = `Lo lamento, ¿puedes decirlo de nuevo? Prueba a decir: "Es segura" o "No es segura". ¿La escena es segura?`;
                        ...
                        "datasources": {
                            "simpleTextTemplateData": {
                                ...
                                "properties": {
                                    ...
                                    "hintText": "Prueba a decir: \"Es segura\", \"No es segura\", \"Que es una escena segura?\"",
                                    "headerAttributionImage": "https://raw.githubusercontent.com/IbaGPE/Asistente-B.L.S/main/Alexa-Logo.png",
                                    "primaryText": "Usted se encuentra caminando por la vía pública y encuentra un paciente inconsciente recibiendo maniobras de R.C.P. Por un reanimador.",
                                    "textAlignment": "start",
                                    "titleText": "Simulación"
                                }
                            }
  ...
  default:
      caso=1;
      paciente=1;
      escenario = 'Usted se encuentra en una plaza comercial, usted observa que hay una persona aparentemente inconsciente y decide acercarse al lugar.';
      speakOutput = `Hola, soy tu asistente virtual.  Iniciaremos la práctica de B.L.S. Y el escenario es el siguiente: ${escenario} `;
      speakOutput2 = `Lo lamento, ¿puedes decirlo de nuevo? Prueba a decir: "Es segura" o "No es segura". ¿La escena es segura?`;
        return handlerInput.responseBuilder
            .addDirective({
                        ...
                        "datasources": {
                            "simpleTextTemplateData": {
                                ...
                                "properties": {
                                    ...
                                    "hintText": "Prueba a decir: \"Es segura\", \"No es segura\", \"¿Que es una escena segura?\"",
                                    "headerAttributionImage": "https://raw.githubusercontent.com/IbaGPE/Asistente-B.L.S/main/Alexa-Logo.png",
                                    "primaryText": "Usted se encuentra en una plaza comercial, usted observa que hay una persona aparentemente inconsciente y decide acercarse al lugar.",
                                    "textAlignment": "start",
                                    "titleText": "Simulación"
                                }
                            }
...
const RespondeHandler = {
    ...
    handle(handlerInput) {
        ...
        if(paciente===0)
        {
           speakOutput = 'De acuerdo, asegúrese que la integridad del lactante este a salvo y localice al padre o tutor del menor, en caso de no localizarlos comuníquese con el servicio de emergencias.';
                        ...
                        "datasources": {
                            "simpleTextTemplateData": {
                                ...
                                "properties": {
                                    ...
                                    "headerAttributionImage": "https://raw.githubusercontent.com/IbaGPE/Asistente-B.L.S/main/Alexa-Logo.png",
                                    "primaryText": "Asegúrese que la integridad del lactante este a salvo y localice al padre o tutor del menor, en caso de no localizarlos comuníquese con el servicio de emergencias.",
                                    "textAlignment": "start",
                                    "titleText": "Simulación"
                                }
                            }
...
const SiPulsoHandler = {
    ...
    handle(handlerInput) {
        ...
        estado=5;
         ...
         if(caso===3)
        {
           speakOutput = 'La escena no es segura, ¿Cómo has tomado el pulso? ¡¡¡Solo llama a emergencias y mantente a salvo!!! ¿Entendido?'; 
                    return handlerInput.responseBuilder
            .addDirective(
                                    {
                        "type": "Alexa.Presentation.APL.RenderDocument",
        ...
        {
            speakOutput = 'Okey, ¿el lactante tiene respiración normal?';
                    return handlerInput.responseBuilder
            .addDirective(
                                    {
                        "type": "Alexa.Presentation.APL.RenderDocument",
...
const NoPulsoHandler = {
    ...
    handle(handlerInput) {
        ...
        {
            speakOutput = 'Okey, pide en voz alta a alguien que solicite un D.E.A. Y que te informe cuando ya lo haya solicitado, inmediatamente inicie la maniobra de R.C.P. Dando 2 ventilaciones por cada 30 compresiones, si acude un segundo reanimador da 2 ventilaciones por cada 15 compresiones. ¿Entendido?';
                return handlerInput.responseBuilder
            .addDirective(
                                    {
                        "type": "Alexa.Presentation.APL.RenderDocument",
...
const SiRespiraHandler = {
    ...
    handle(handlerInput) {
       ...
       if(caso===3)
        {
           speakOutput = 'La escena no es segura, ¿Cómo has comprobado la respiración? ¡¡¡Solo llama a emergencias y mantente a salvo!!! ¿Entendido?'; 
           speakOutput2 = 'Lo lamento no te he entendido, ¿puedes decirlo de nuevo? Prueba a decir: "Entendido" o "Eso es todo".';
                  return handlerInput.responseBuilder
            .addDirective(
                                    {
        ...
        if (paciente===1)
        {
            speakOutput = 'Okey, Permanece al lado de la víctima y controla su estado hasta la llegada de los reanimadores de emergencias. Infórmame si ocurre algún cambio en el estado del paciente.';
    ...
    handle(handlerInput) {
                        ...
                        "datasources": {
                            "simpleTextTemplateData": {
                                ...
                                "properties": {
                                    ...
                                    "headerAttributionImage": "https://raw.githubusercontent.com/IbaGPE/Asistente-B.L.S/main/Alexa-Logo.png",
                                    "primaryText": "Proporcione ventilación de rescate a razón de 1 ventilación cada 5 o 6 segundos. Manténgase atento a las indicaciones del D.E.A.",
                                    "textAlignment": "start",
                                    "titleText": "Simulación"
                                }
                            }
        ...
        else
        {
           ...
           .getResponse();
            ...
            {
                speakOutput = 'Okey, proporciona ventilación de rescate a razón de 1 ventilación cada 3 o 5 segundos, unas 17 ventilaciones por minuto. Si el pulso se mantiene menor o igual a 60 I.P.M. Con signos de mala perfusión, añada compresiones. Además, comprueba el pulso cada 2 minutos aproximadamente. ¿Entendido?';
                speakOutput2= 'Lo lamento no te he entendido, ¿puedes decirlo de nuevo? Prueba a decir: "Entendido" o "Entro en paro" o "¿Que es ventilación?".';       
                        return handlerInput.responseBuilder
           .addDirective(
                                    {
...
const AsistenciaCompresionesHandler = {
     canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'AsistenciaContracciones'
                        ...
                        "datasources": {
                            "simpleTextTemplateData": {
                                ...
                                "properties": {
                                    ...
                                    "headerAttributionImage": "https://raw.githubusercontent.com/IbaGPE/Asistente-B.L.S/main/Alexa-Logo.png",
                                    "primaryText": "Manténgase al tanto del paciente.",
                                    "textAlignment": "start",
                                    "titleText": "Simulación"
                                }
                            }
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Con esta skill puedes practicar el procedimiento de B.L.S por simulación.';
